...
if(CMAKE_C_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    if(${CMAKE_C_COMPILER_VERSION} VERSION_GREATER_EQUAL "14" AND ${CMAKE_C_COMPILER_VERSION} VERSION_LESS "15")
        set(GCC_C_MAJOR_VERSION "14")
    elseif(${CMAKE_C_COMPILER_VERSION} VERSION_GREATER_EQUAL "13" AND ${CMAKE_C_COMPILER_VERSION} VERSION_LESS "14")
        set(GCC_C_MAJOR_VERSION "13")
    elseif(${CMAKE_C_COMPILER_VERSION} VERSION_GREATER_EQUAL "12" AND ${CMAKE_C_COMPILER_VERSION} VERSION_LESS "13")
    ...
    elseif(${CMAKE_CXX_COMPILER_VERSION} VERSION_GREATER_EQUAL "13" AND ${CMAKE_CXX_COMPILER_VERSION} VERSION_LESS "14")
        set(GCC_CXX_MAJOR_VERSION "13")
    elseif(${CMAKE_CXX_COMPILER_VERSION} VERSION_GREATER_EQUAL "12" AND ${CMAKE_CXX_COMPILER_VERSION} VERSION_LESS "13")
